...
import { Anchor, Annotation, AnnotationBuilder, AnnotationCircle, AnnotationInk, AnnotationLink, AnnotationPolygon, AnnotationSquare, AnnotationUrl, CircleAnnotation, InkAnnotation, Link, Outline, PolygonAnnotation, PolyLineAnnotation, SquareAnnotation, UrlLink } from './widgets/annotations.ts';
...
import { BoxDecoration, BoxShadow, DecorationGraphic, DecorationImage, Gradient, LinearGradient, RadialGradient } from './widgets/decoration.ts';
...
export type { CheckboxOptions, ChoiceFieldOptions, FlatButtonOptions, PdfFieldFlag, TextFieldOptions } from './widgets/forms.ts';
export type { AnchorOptions, AnnotationLayoutData, AnnotationOptions, AnnotationRect, GeometricAnnotationOptions, InkAnnotationBuilderOptions, InkAnnotationOptions, LinkOptions, OutlineOptions, PdfBorder, PointAnnotationOptions, PolygonAnnotationOptions, ShapeAnnotationOptions } from './widgets/annotations.ts';
...
export type { AnyLayoutBox, AnyWidget, Constraints, DocumentContext, LayoutBox, PositionedBox, RenderContext, SpanLayout, StatelessLayoutData, DelayedWidgetLayoutData, DelayedWidgetOptions, DelayedWidgetState, InheritedWidgetLayoutData, InheritedWidgetOptions, InheritedWidgetState, InseparableOptions } from './widgets/widget.ts';
...
export type { Axis, ColumnOptions, CrossAxisAlignment, ExpandedOptions, FlexChildLayout, FlexibleLayoutData, FlexibleOptions, FlexFit, FlexLayoutData, FlexOptions, IndexedWidgetBuilder, ListViewOptions, MainAxisAlignment, MainAxisSize, RowOptions, VerticalDirection } from './widgets/flex.ts';
...
export type { BulletOptions, HeaderOptions, ParagraphOptions, TableOfContentOptions, FooterOptions, WatermarkOptions } from './widgets/content.ts';
...
export type { BoxDecorationInput, BoxDecorationOptions, BoxShadowInput, BoxShadowOptions, BoxShape, DecorationPosition, DecorationImageOptions, GradientOptions, LinearGradientOptions, PaintPhase, RadialGradientOptions, TileMode } from './widgets/decoration.ts';
...
export type { IconDataOptions, IconOptions, IconThemeDataOptions } from './widgets/icon.ts';
export type { CircularProgressIndicatorOptions, LinearProgressIndicatorOptions } from './widgets/progress.ts';
...
export type { DocumentDestinationEntry, DocumentOptions, DocumentOutlineEntry } from './widgets/document.ts';
export type { PdfPageMode, SerializedDestination, SerializedOutline, SerializedPageLabel } from './pdf/document.ts';
...
export declare const js_pdf: Readonly<{
    ...
    Icon: typeof Icon;
    IconData: typeof IconData;
    IconThemeData: typeof IconThemeData;
    ...
    FlatButton: typeof FlatButton;
    TextField: typeof TextField;
    Anchor: typeof Anchor;
    Annotation: typeof Annotation;
    AnnotationBuilder: typeof AnnotationBuilder;
    AnnotationCircle: typeof AnnotationCircle;
    AnnotationInk: typeof AnnotationInk;
    AnnotationLink: typeof AnnotationLink;
    AnnotationPolygon: typeof AnnotationPolygon;
    AnnotationSquare: typeof AnnotationSquare;
    AnnotationUrl: typeof AnnotationUrl;
    CircleAnnotation: typeof CircleAnnotation;
    ...
    SquareAnnotation: typeof SquareAnnotation;
    UrlLink: typeof UrlLink;
    Page: typeof Page;
    ...
    DecorationGraphic: typeof DecorationGraphic;
    DecorationImage: typeof DecorationImage;
    ...
    Inherited: typeof Inherited;
    InheritedWidget: typeof InheritedWidget;
    Inseparable: typeof Inseparable;
    DelayedWidget: typeof DelayedWidget;
    Directionality: typeof Directionality;
    InheritedDirectionality: typeof InheritedDirectionality;
